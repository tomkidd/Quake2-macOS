...
void AddressBook_MenuInit( void )
{
	...
	s_addressbook_menu.y = SCREEN_HEIGHT*0.5 - 58;
//	s_addressbook_menu.x = viddef.width / 2 - SCR_ScaledVideo(MENU_FONT_SIZE*17.75);	// was 142
//	s_addressbook_menu.y = viddef.height / 2 - SCR_ScaledVideo(MENU_FONT_SIZE*7.25);	// was 58
...
{
	Menu_Banner ("m_banner_addressbook");
